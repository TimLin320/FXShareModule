...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FXShareModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/linmeng320@gmail.com/FXShareModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'linmeng320@gmail.com' => 'linmeng320@163.com' }
  s.source           = { :git => 'https://github.com/linmeng320@gmail.com/FXShareModule.git', :tag => s.version.to_s }
